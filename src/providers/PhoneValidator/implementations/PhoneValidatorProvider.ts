...
export default class PhoneValidatorProvider implements IPhoneValidatorProvider {
  ...
  private countriesRegex:IRegExs[] = [
    {country_code: '258', regex: /\(258\)\ ?[28]\d{7,8}$/g},
    {country_code: '256', regex: /\(256\)\ ?\d{9}$/g},
    {country_code: '237', regex: /\(237\)\ ?[2368]\d{7,8}$/g},
    {country_code: '251', regex: /\(251\)\ ?[1-59]\d{8}$/g},
    {country_code: '212', regex: /\(212\)\ ?[5-9]\d{8}$/g},
  ];
